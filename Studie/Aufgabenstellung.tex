...
Der aufeinander abgestimmte Vorschub des WerkstÃ¼cks und abfahren der Fokuslinie des Lasers wird hier nicht betrachtet, da nur die Ablenkung des Laserstrahls im Zentrum der 
Studie steht.
...
\item Durch verdrehen des Spiegels kann der Laserstrahl nicht vom Spiegel "fallen" (wäre der Spiegel zu weit gedreht, so dass der Laserstrahl nur noch auf eine kleine 
Ablenkfläche trifft, würde der mittlere Teil des Laserstrahls abgelenkt und der äußere Teil würde am Spiegel vorbei "laufen")
...
Diesem P-Regler ist eine Funktion vorgeschaltet, die es über zwei einzugebende Parameter erlaubt, näher an den Sollwert zu gelangen.