...
Als Alternative kommt die s.g. P-Adaption in Betracht. Bei der P-Adaption gibt es im Regelkreis nur einen P-Regler. Diesem P-Regler ist eine Funktion vorgeschaltet, die es 
über zwei einzugebende Parameter erlaubt, näher an den Sollwert zu gelangen.