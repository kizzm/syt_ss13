...
Die Ablenkung des Laserstrahls erfolgt durch einen Spiegel, der auf der Welle eines Gleichstrommotors fest montiert ist.
...
\item Durch verdrehen des Spiegels kann der Laserstrahl nicht vom Spiegel \glqq fallen \grrq (wäre der Spiegel zu weit gedreht, so dass der Laserstrahl nur noch auf eine kleine 
Ablenkfläche trifft, würde der mittlere Teil des Laserstrahls abgelenkt und der äußere Teil würde am Spiegel vorbei \glqq laufen \grrq)
