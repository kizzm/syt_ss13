...
Sowie der Moment-Winkel-Beziehung (Reibung) $M_R = r*\omega$, mit $\omega = \. \phi$ (siehe Abb. \ref{mecheinzelteil})
\begin{figure}[!h]
	\centering
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.8\textwidth]{Sensor_Funktion.jpg}
...
\textbf{Die Blende}\\
Die Blende wir im folgenden als masselos und völlig lichtundurchlässig angenommen.
