...
\end{equation}
\end{center}
Der Spiegel erfährt zu Beginn der Regelung eine Beschleunigung von $\alpha = \unit{1,396 *10^6}{rad/s^2}$ um nach der Hälfte der Zeit, also nach \unit[0,5]{ms} wieder mit 
