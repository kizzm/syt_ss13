...
Für die folgenden Simulationen wird das Matlab-File \texttt{msSpiegel{\_}Pad{\_}Werte.m} und das Simulink-File \texttt{sSpiegelPad.slx} benutzt.
...
\end{figure}
\FloatBarrier
Für die folgenden Simulationen wird das Matlab-File \texttt{msSpiegel{\_}Pad{\_}Neue{\_}Werte{\_}Strom.m} und das Simulink-File \texttt{sSpiegelPadStrom.slx} benutzt.
...
Dafür wird das vorhandene Simulink-File \texttt{sSpiegelPadStrom.slx} verwendet und um den Sensor erweitert.
