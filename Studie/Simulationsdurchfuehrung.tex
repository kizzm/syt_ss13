...
\end{figure}
Für die folgenden Simulationen wird das Matlab-File \texttt{msSpiegel{\_}Pad{\_}Neue{\_}Werte_Strom.m} und das Simulink-File \texttt{sSpiegelPadStrom.slx} hergenommen.
