...
function signal = sensor(Blendenwinkel,Unit,Sensorkonstante)
...
S13 = @(phi) Sensorkonstanten(1)*(1-a(phi)) % Signal der Sensoren 1+3
S24 = @(phi) Sensorkonstanten(1)*a(phi) % Signal der Sensoren 2+4
